...
<body style="background-image: url('pexels-photo-733745(blur).png'); height: 100%; background-position: center; background-repeat: no-repeat; background-size: cover;">
            ...
            <div class="login-content">
                ...
                <div class="login-form" style="border-radius: 15px; background-color:rgba(0,0,0,.2); ">
                    <form method="post">
                        ...
                        <button style="border-radius: 15px;" type="submit" name="login" class="btn btn-success btn-flat m-b-30 m-t-30">Sign in</button>
                       
                       <div class="checkbox" style="padding-bottom: 20px;padding-top: 20px;">
                            
                            <label class="pull-left" >
                                <a href="signup.php" style="color:white;">Signup (Register yourself)</a>
                            </label>
