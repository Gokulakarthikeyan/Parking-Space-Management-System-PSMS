                                ...
                                <div class="card-body card-block">
                                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        <div class="row form-group" style="padding: 5px;">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label" style="font-size: 20px;">Category Name</label></div>
                                            <div class="col-12 col-md-9"><input type="text" id="catename" name="catename" class="form-control" placeholder="Vehicle Category" required="true"style="font-size: 15px;"></div>
                                        </div>
