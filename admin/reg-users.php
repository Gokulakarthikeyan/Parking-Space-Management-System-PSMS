...
?>
                ...
                <tr>
                  ...
                  <td><a href="reg-users.php?del=<?php echo $row['ID'];?>" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete?')" style="font-size: 18 px;">Delete</a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
