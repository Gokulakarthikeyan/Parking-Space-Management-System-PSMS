...
?>
                ...
                <tr>
                  ...
                  <td><a href="view-incomingvehicle-detail.php?viewid=<?php echo $row['ID'];?>" class="btn btn-primary"style="font-size: 18px;">View</a> 

<a href="print.php?vid=<?php echo $row['ID'];?>" style="cursor:pointer; font-size: 18px;" target="_blank" class="btn btn-warning">Print</a>
<a href="manage-incomingvehicle.php?del=<?php echo $row['ID'];?>" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete?')"style="font-size: 18px;">Delete</a>
                  </td>
                </tr>
                <?php 
$cnt=$cnt+1;
