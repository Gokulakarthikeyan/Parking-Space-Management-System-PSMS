...
.show {display: block;}
    ...
    echo $msg;
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label"style="font-size:18px;">From Date</label></div>
                                        <div class="col-12 col-md-9"><input type="date" name="fromdate" id="fromdate" class="form-control" required="true"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label"style="font-size:18px;">To Date</label></div>
                                   ...
                                   <p style="text-align: center;"> <button type="submit" class="btn btn-primary btn-sm" name="submit" style="font-size:18px;background-color: #04AA6D;">Submit</button></p>
                                </form>
                            </div>
